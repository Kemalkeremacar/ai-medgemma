...
DEFAULT_BUNDLE = ROOT / "SUT/generated/dgx_handoff/review_reduction_dgx_transfer_bundle_20260709"
DEFAULT_ZIP = ROOT / "SUT/generated/dgx_handoff/review_reduction_dgx_transfer_bundle_20260709.zip"
...
def validate(bundle: Path, zip_path: Path, proposal_dir: Path) -> dict[str, Any]:
    errors: list[str] = []
